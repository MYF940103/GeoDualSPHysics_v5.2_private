...
protected:
  ...
  float* MccSubstepCountc;
  float* MccSubstepFailureCountc;
  float* MccAdmissibilityFailureCountc;
  float* MccFallbackUsedc;
  float* MccSubstepTriggerReasonc;
  float* MccLineSearchBacktrackCountc;
  float* MccLineSearchRejectReasonc;
  float* MccLineSearchMinAlphac;
  //===============  
  ...
  float* LapPorePressGhostc; ///<Diagnostic pore-pressure Laplacian using output-only hydraulic boundary ghost values.
  float* LapZGhostc; ///<Diagnostic elevation-head Laplacian using output-only hydraulic boundary ghost values.
  ...
  void ComputePorePressureAccel(unsigned n,unsigned pini
    ,StDivDataCpu divdata,const unsigned *dcell,const tdouble3 *pos,const tfloat4 *velrhop,const typecode *code,const double *porepress,tfloat3 *porepressureace)const;
  template<TpKernel tker> void ComputePorePressureAccelPaperT(unsigned n,unsigned pini
    ,StDivDataCpu divdata,const unsigned *dcell,const tdouble3 *pos,const tfloat4 *velrhop,const typecode *code,const double *porepress,tfloat3 *porepressureace)const;
  void ComputePorePressureAccelPaper(unsigned n,unsigned pini
    ,StDivDataCpu divdata,const unsigned *dcell,const tdouble3 *pos,const tfloat4 *velrhop,const typecode *code,const double *porepress,tfloat3 *porepressureace)const;
  template<TpKernel tker> void ComputePorePressureAccelDiffT(unsigned n,unsigned pini
  ...
  void ApplyMechanicalTopLoad(unsigned n,unsigned pini,const typecode *code,const tdouble3 *pos,const tfloat4 *velrhop,tfloat3 *ace)const;
  void ApplyCapConfiningStress(unsigned n,unsigned pini,const typecode *code,const tdouble3 *pos,const tfloat4 *velrhop,tfloat3 *ace)const;
  ...
  void ComputeHydroLapPorePressGhost(unsigned n,unsigned pini
    ,StDivDataCpu divdata,const unsigned *dcell,const tdouble3 *pos,const tfloat4 *velrhop,const typecode *code
    ,const double *porepress,const double *porepressghost,const float *porepressureboundarymode,float *lapporepressghost)const;
  template<TpKernel tker> void ComputeHydroLapZGhostT(unsigned n,unsigned pini
    ,StDivDataCpu divdata,const unsigned *dcell,const tdouble3 *pos,const tfloat4 *velrhop,const typecode *code
  ...
  template<TpKernel tker,bool sim2d,TpSlipMode tslip> void InteractionMdbcCorrectionT2
    ...
    (unsigned n,StDivDataCpu divdata,float determlimit,float mdbcthreshold
    ,const tdouble3 *pos,const typecode *code,const unsigned *idp
    ,const tfloat3 *boundnormal,const tfloat3 *motionvel,tfloat4 *velrhop,tsymatrix3f *sigma);//mdbr
