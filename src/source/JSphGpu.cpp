...
void JSphGpu::InitRunGpu(){
  ...
  if(ConfiningStressLateralSelectorStartTime>0.)Run_Exceptioon("ConfiningStressLateralSelectorStartTime is CPU-only in this branch. GPU support is not implemented.");
