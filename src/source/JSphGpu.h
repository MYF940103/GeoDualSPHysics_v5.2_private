...
protected:
  ...
  byte   *BoundSlipModeg;///<Per-particle mDBC slip mode when per-mkbound overrides are active.
  ...
  void ConstantDataUp();
  void ParticlesDataUp(unsigned n,const tfloat3 *boundnormal,const byte *boundslipmode);
