...
set case=CaseCryerProblem_PR_nu010
set xml=%case%
...
rem k=1e-5 with nu010 gives Tv=1 at 1.199 s.
...
set CRYER_OUTTAG=cryer_center_pressure_dp0025_k1e5_nu010
set CRYER_SUMMARY_JSON=%figures%\cryer_center_pressure_dp0025_k1e5_nu010_summary.json
