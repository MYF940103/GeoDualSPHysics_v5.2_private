...
set case=CaseCryerProblem_PR_dp002_rampclosed_nu030
set xml=%case%
...
rem dp=0.002, k=1e-5, nu030; Tv=1 after ramp corresponds to 0.910928571429 s.
...
set nu=0.3
set loadramp=0.0025
set tvperiod=0.910928571429
set tmax=0.913428571429
...
set CRYER_OUTTAG=cryer_center_pressure_dp002_k1e5_rampclosed_nu030
set CRYER_SUMMARY_JSON=%figures%\cryer_center_pressure_dp002_k1e5_rampclosed_nu030_summary.json
