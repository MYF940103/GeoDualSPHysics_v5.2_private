...
set case=CaseCryerProblem_PR_dp002_rampclosed_nu045
set xml=%case%
...
rem dp=0.002, k=1e-5, nu045; Tv=1 after ramp corresponds to 0.323284090909 s.
...
set nu=0.45
set loadramp=0.0025
set tvperiod=0.323284090909
set tmax=0.325784090909
...
set CRYER_OUTTAG=cryer_center_pressure_dp002_k1e5_rampclosed_nu045
set CRYER_SUMMARY_JSON=%figures%\cryer_center_pressure_dp002_k1e5_rampclosed_nu045_summary.json
