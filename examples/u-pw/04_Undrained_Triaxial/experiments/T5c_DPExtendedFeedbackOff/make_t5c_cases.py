#!/usr/bin/env python3
"""Generate T5c slightly longer DP feedback-off platen response cases."""
...
CASES = [
    {
        "name": "CaseT5c_DPHighStrength_ExtendedFeedbackOff",
        "date": "T5c DP high-strength extended feedback-off platen response",
        "label": "dp_high_strength",
        "model": "1",
        "model_comment": "Drucker-Prager high-strength elastic-like extended reference",
        "phi": "33",
        "coh": "10000",
        "dlt": "0",
    },
    {
        "name": "CaseT5c_DPMildYield_ExtendedFeedbackOff",
        "date": "T5c DP mild-yield extended feedback-off platen response",
        "label": "dp_mild_yield",
        "model": "1",
        "model_comment": "Drucker-Prager mild-yield extended response diagnostic",
        "phi": "30",
        "coh": "50",
        "dlt": "0",
    },
...
def main() -> None:
    ...
    with (ROOT / "README.md").open("w", newline="\n") as f:
        f.write(
            "# T5c DP Extended Feedback-Off Response\n\n"
            "Run `py -3 make_t5c_cases.py`, then execute the generated CPU Release BAT files.\n"
            "Use `py -3 analyze_t5c_dp_extended_feedback_off.py` after the runs.\n"
        )
