...
set CASES=CaseCryer_PR_StrictSphere_C5f_DiffusionRaw CaseCryer_PR_StrictSphere_C5f_DiffusionNormalized CaseCryer_PR_StrictSphere_C5f_DiffusionCapped CaseCryer_PR_StrictSphere_C5f_CompressionRaw CaseCryer_PR_StrictSphere_C5f_CompressionNormalized CaseCryer_PR_StrictSphere_C5f_CompressionCapped
...
echo.
echo === C5f analysis ===
py "%BASEDIR%scripts\analyze_c5f_boundary_particle_weighting.py"
if errorlevel 1 exit /b 1
