...
call :run_case CaseCryer_PR_StrictSphere_C5b_Baseline
if not "%ERRORLEVEL%" == "0" goto fail
call :run_case CaseCryer_PR_StrictSphere_C5b_SlowRamp
if not "%ERRORLEVEL%" == "0" goto fail
call :run_case CaseCryer_PR_StrictSphere_C5b_LowerP0
if not "%ERRORLEVEL%" == "0" goto fail
call :run_case CaseCryer_PR_StrictSphere_C5b_LongSlowRamp
if not "%ERRORLEVEL%" == "0" goto fail

py scripts\analyze_c5b_refinement.py
if not "%ERRORLEVEL%" == "0" goto fail
py scripts\plot_c5b_refinement.py
if not "%ERRORLEVEL%" == "0" goto fail

echo C5b strict-sphere refinement completed.
goto end
...
:fail
echo C5b strict-sphere refinement failed.
