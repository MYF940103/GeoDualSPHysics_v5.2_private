#!/usr/bin/env python3
"""Create radial profile diagnostics for the C4-D no-elevation smoke outputs."""
...
def main() -> None:
    ...
    fields = [
        ("ex", "excess pressure [Pa]", "c4d_radial_excess_pressure_profiles"),
        ("rate", "PorePressRate [Pa/s]", "c4d_radial_porepressrate_profiles"),
        ("lap", "LapPorePress [Pa/m2]", "c4d_radial_lapporepress_profiles"),
    ]
