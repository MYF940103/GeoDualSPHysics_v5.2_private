# C5c Curved Drained Boundary Coupling

This directory contains targeted CPU-only tests for the C5c Cryer boundary
coupling refinement. These cases are not final Cryer Figure 7B reproduction.
...
```bat
xCaseCryer_PR_StrictSphere_C5c_CurvedBoundaryCoupling_win64_CPU_release.bat
```
