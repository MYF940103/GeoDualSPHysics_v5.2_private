...
set CASES=C5o_Pos C5o_B025 C5o_B050 C5o_B050Pos
...
echo.
echo === C5o analysis ===
py -3 "%BASEDIR%analyze_corrected_laplacian_stabilization.py"
if errorlevel 1 exit /b 1

echo.
echo C5o corrected Laplacian stabilization pressure-only gate complete.
endlocal
