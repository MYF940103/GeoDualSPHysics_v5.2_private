...
set CASES=CaseCryer_PR_StrictSphere_C5k_FinerDiffusionShellFlux CaseCryer_PR_StrictSphere_C5k_CoarseDiffusionShellFlux
...
echo.
echo === C5k analysis ===
py -3 "%BASEDIR%scripts\analyze_c5k_radial_shell_flux.py"
if errorlevel 1 exit /b 1

echo.
echo C5k pressure-only gate complete.
endlocal
