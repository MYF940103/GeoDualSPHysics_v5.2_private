...
set CASES=CaseCryer_PR_StrictSphere_C5n_FinerDiffusionCorrectedLap
...
echo.
echo === C5n analysis ===
py -3 "%BASEDIR%analyze_corrected_laplacian_operator.py"
if errorlevel 1 exit /b 1

echo.
echo C5n corrected Laplacian pressure-only gate complete.
endlocal
