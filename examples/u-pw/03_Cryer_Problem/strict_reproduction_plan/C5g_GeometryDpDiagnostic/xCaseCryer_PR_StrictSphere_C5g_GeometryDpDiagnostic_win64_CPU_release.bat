...
set CASES=CaseCryer_PR_StrictSphere_C5g_CoarseCompressionNormalized CaseCryer_PR_StrictSphere_C5g_FinerCompressionNormalized CaseCryer_PR_StrictSphere_C5g_CoarseDiffusionNormalized CaseCryer_PR_StrictSphere_C5g_FinerDiffusionNormalized
...
echo.
echo === C5g analysis ===
py "%BASEDIR%scripts\analyze_c5g_geometry_dp_diagnostic.py"
if errorlevel 1 exit /b 1
