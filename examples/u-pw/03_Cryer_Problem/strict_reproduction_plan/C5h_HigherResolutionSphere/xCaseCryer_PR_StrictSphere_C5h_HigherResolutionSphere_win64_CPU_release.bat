...
set CASES=CaseCryer_PR_StrictSphere_C5h_HigherResCompressionNormalized CaseCryer_PR_StrictSphere_C5h_HigherResDiffusionNormalized
...
echo.
echo === C5h analysis ===
py "%BASEDIR%scripts\analyze_c5h_higher_resolution_sphere.py"
if errorlevel 1 exit /b 1
