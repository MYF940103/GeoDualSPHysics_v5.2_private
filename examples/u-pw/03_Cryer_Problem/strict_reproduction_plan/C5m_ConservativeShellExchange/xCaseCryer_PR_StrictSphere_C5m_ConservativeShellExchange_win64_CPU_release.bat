...
set CASES=CaseCryer_PR_StrictSphere_C5m_FinerDiffusionShellExchange CaseCryer_PR_StrictSphere_C5m_CoarseDiffusionShellExchange
...
echo.
echo === C5m analysis ===
py -3 "%BASEDIR%scripts\analyze_c5m_conservative_shell_exchange.py"
if errorlevel 1 exit /b 1

echo.
echo C5m pressure-only gate complete.
endlocal
