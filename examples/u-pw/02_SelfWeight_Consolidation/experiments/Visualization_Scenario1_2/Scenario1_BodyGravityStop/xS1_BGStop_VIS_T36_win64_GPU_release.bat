...
rem Full GPU calculation and particle VTK output for Scenario 1 BodyGravityStopTime.
rem This BAT intentionally keeps the complete output so it can be opened or post-processed later.

set name=S1_BGStop_VIS_T36
set dirout=%name%_gpu_out
set diroutdata=%dirout%\data
set dirvtk=%name%_vtk_particles
