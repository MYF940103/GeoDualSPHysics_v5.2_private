...
%measuretool% -dirin %diroutdata% -points PointsVelocity.txt -onlytype:-all,+fluid -distinter_2h:0.75 -vars:-all,+vel.x,+vel.m -savevtk %dirout2%/PointsVelocity -savecsv %dirout2%/_PointsVelocity
if not "%ERRORLEVEL%" == "0" goto fail
