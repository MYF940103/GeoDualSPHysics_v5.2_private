...
export dirout2=${dirout}/surfaceY=0
${isosurface} -dirin ${diroutdata} -saveslice ${dirout2}/Slices -distinter_2h:1.8 -vars:-all,mass,vol,rhop -slicevec:0:0:0:0:1:0

export dirout2=${dirout}/surfaceX=212
${isosurface} -dirin ${diroutdata} -saveslice ${dirout2}/Slices -distinter_2h:1.8 -vars:-all,mass,vol,rhop -slicevec:0.212:0:0:1:0:0
